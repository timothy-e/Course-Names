...
function replaceCourse(courseCode, courseName, text) {
    ...
    return text.replace(
        regexCourseCode,
        "<a href='' title='" + courseName +
        "' style='background-color:white;color:black;text-decoration:none'>" + courseCode + "</a>"
    )
}
...
function linkCourses(subject, nodeList, insertCourses) {
    ...
    xhr.open("GET", "https://www.ucalendar.uwaterloo.ca/1819/COURSE/course-" + subject + ".html", true);
